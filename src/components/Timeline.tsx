...
const TimelineIcon = ({ icon }: { icon: string }) => {
  ...
  return (
    <div className="w-12 h-12 bg-gold rounded-full flex items-center justify-center text-navy font-semibold shadow-lg">
    ...
    >
      <div className="mx-auto max-w-4xl">
        <div className="elegant-frame">
          <div className="elegant-card p-8 md:p-12">
            ...
            <div className="relative">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gold/30 h-full hidden md:block"></div>
              ...
              <div className="space-y-8 md:space-y-12">
                {siteConfig.timeline.map((item, index) => (
                  <div key={index} className={`relative flex items-center ${
                    ...
                    <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gold rounded-full border-4 border-cream hidden md:block z-10"></div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="text-center mt-8">
          <div className="inline-block text-gold/60">
            ✦ ✦ ✦
          </div>
        </div>
      </div>
