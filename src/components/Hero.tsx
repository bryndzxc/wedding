    ...
    <MotionConfig reducedMotion="user">
      ...
      >
        ...
        >
          <picture>
            <source 
              ...
              srcSet="/images/prenup-photoshoot/AE873F0D-9B90-4AF4-B7A4-81B23C5E1353A9204675.jpeg" 
            />
            <img 
              src="/images/prenup-photoshoot/AE873F0D-9B90-4AF4-B7A4-81B23C5E1353A9204675.jpeg" 
        ...
        >
          {/* Couple Names */}
          <motion.h1 
            className="hero-text text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl tracking-wider mb-8 relative z-20"
            style={{
              color: 'white',
              textShadow: '0 0 30px rgba(0,0,0,0.9), 2px 2px 8px rgba(0,0,0,0.8)',
              letterSpacing: '0.1em',
              fontWeight: '600',
          ...
          >
            ...
            <span 
              ...
              style={{
                color: '#C9A857',
                textShadow: '0 0 20px rgba(0,0,0,0.8), 2px 2px 4px rgba(0,0,0,0.6), 0 0 40px rgba(0,0,0,0.4)',
                fontFamily: 'serif',
          ...
          {/* Wedding Date */}
          <motion.div 
            className="font-body text-xl md:text-2xl lg:text-3xl tracking-widest mb-12 relative z-20"
            variants={fadeUpVariants}
          >
            <div
              className="hero-text"
          ...
          >
            <motion.button
              ...
              className="inline-flex items-center justify-center rounded-full bg-brand-navy px-8 py-3 text-white font-medium text-lg transition-all duration-300 hover:bg-brand-navy/90 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-brand-navy focus:ring-offset-2 shadow-lg"
